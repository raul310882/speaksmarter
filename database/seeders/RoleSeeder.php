...
use Spatie\Permission\Models\Permission;   // permisos de spatie
use Spatie\Permission\Models\Role;          //  roles de spatie
...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permission_create_role = Permission::create(['name' => 'create roles']); //crear permisos y darle un nombre
        ...
        $permissions_admin = [$permission_create_role, $permission_read_role, $permission_update_role, $permission_delete_role,   //permisos del administrador
        ...
        $permissions_editor = [$permission_create_lesson, $permission_read_lesson, $permission_update_lesson, $permission_delete_lesson,    //permisos del editor
                            $permission_create_category, $permission_read_category, $permission_update_category, $permission_delete_category];

        $role_admin->syncPermissions($permissions_admin); //sincronizar permisos
